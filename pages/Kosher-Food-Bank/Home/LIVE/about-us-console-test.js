// ====================================================================
// ABOUT US PAGE STYLING - BROWSER CONSOLE TEST
// ====================================================================
// HOW TO USE:
// 1. Open https://www.jrcc.org/templates/articlecco_cdo/aid/6820886/jewish/About-Us.htm
...
(function() {
    console.clear();
    console.log('%c🎨 Applying Modern About Us Page Styles...', 'color: #d4af37; font-size: 20px; font-weight: bold;');

    // Remove any existing versions
    const existing = document.getElementById('about-us-test-styles');
    if (existing) existing.remove();

    // Create a style element
    const style = document.createElement('style');
    style.id = 'about-us-test-styles';

    // Add all the CSS
    style.textContent = `
/* ====================================================================
   ABOUT US PAGE STYLING - BLACK/WHITE/GOLD THEME
...
/* Main article wrapper - beautiful card design */
/* Make all parent containers transparent */
.chabad_left_column,
#ContentArea,
.content_page,
#content_page,
...
/* Style ONLY the innermost content container as the card */
.co_body.article-body.cf,
div.co_body.article-body.cf {
...
/* Article text content - enhanced readability */
.co_body.article-body.cf p,
div.co_body.article-body p {
    font-family: 'Urbanist', sans-serif !important;
...
.co_body.article-body.cf p:first-of-type {
...
/* Images within article - base styling */
.co_body.article-body.cf img,
div.co_body.article-body img {
    display: block !important;
...
.co_body.article-body.cf img:nth-of-type(1) {
...
/* Second image - float right */
.co_body.article-body.cf img:nth-of-type(2) {
...
/* Image containers (span elements) - make them transparent wrappers */
.co_body.article-body.cf span {
...
.co_body.article-body.cf strong {
    font-weight: 700 !important;
    color: #000000 !important;
}

/* Links within article */
.co_body.article-body.cf a {
    color: #d4af37 !important;
    text-decoration: none !important;
...
.co_body.article-body.cf a:hover {
    color: #000000 !important;
...
@media (max-width: 768px) {
    .chabad_header {
        ...
        padding: 3rem 1.5rem 7rem 1.5rem !important;
    ...
    /* Stack images on mobile - no floating */
    .co_body.article-body.cf img:nth-of-type(1),
    .co_body.article-body.cf img:nth-of-type(2) {
        float: none !important;
...
@media (max-width: 480px) {
    ...
    console.log('%c✅ Modern About Us page styles applied!', 'color: #50fa7b; font-size: 16px; font-weight: bold;');
    ...
    console.log('%c   • Modern article card design', 'color: #e8e8e8;');
